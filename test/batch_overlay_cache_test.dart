...
void main() {
  test('reuses identical output, invalidates size/settings and caps memory', () async {
  ...
  test('failed rendering can retry', () async {
    ...
    await expectLater(cache.get('a', () async => throw StateError('failed')), throwsStateError);
